  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-200">
        These are projects I am currently developing. While they are not live
        yet, they showcase my skills with modern technologies and innovative
        solutions. Stay tuned for updates as I bring them to life.
      </p>
    </div>
  );
};
